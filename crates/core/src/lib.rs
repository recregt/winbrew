...
pub use paths::{
    ...
    log_dir_at, log_file_at, package_install_dir_at, package_journal_dir_at,
    package_journal_file_at, package_journal_key, package_log_dir_at, package_logs_dir_at,
    package_shim_dir_at, pkgdb_dir_at, resolve_template, resolved_paths, shims_dir_at,
};
